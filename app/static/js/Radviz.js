...
/*
References:
[1] B00813456/assignment2_amirulSunesara_B00813456/Radviz [.js]. (n.d.). https://dal.brightspace.com.
-->
*/

function plotRadviz(data, isDynamic) {
  let radvizCollection = document.querySelector("#plotDiagram");
  let colNames;
  ...
  const radviz = d3.select(radvizCollection);
  let svg = radviz
    .select("#plot")
    .attr("width", 900)
    .attr("height", 400);
  ...
  function dragging(d, i) {
    ...
    document.getElementById("corrMatrix").innerHTML = "<div id='matrix'></div>";
    let tempx = d3.event.x - 155;
    let tempy = d3.event.y - 155;
  ...
  //plot data elements within radviz
